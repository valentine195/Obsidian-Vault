  ...
  state() {
    class StatefulDecorationSet {
      constructor(editor) {
        ...
        __publicField(this, "replacers", /* @__PURE__ */ Object.create(null));
        __publicField(this, "markers", /* @__PURE__ */ Object.create(null));
        this.editor = editor;
      }
      compute(tokens) {
        return __async(this, null, function* () {
          ...
          for (let { from, to } of view.visibleRanges) {
            ...
            tree.iterate({
              ...
              enter: ({ node }) => {
                ...
                const tokenProps = type.prop(import_language2.tokenClassNodeProp);
