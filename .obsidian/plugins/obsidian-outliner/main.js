...
class ObsidianService {
    ...
    getObsidianLegacyEditorSettigns() {
        return Object.assign({ legacyEditor: true }, this.app.vault.config);
    }
    ...
    onload() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.obsidianService.getObsidianLegacyEditorSettigns().legacyEditor) {
                new obsidian.Notice(`Unfortunately Outliner plugin currently does not support a new editor, which was added in Obsidian 0.13. Please consider turning on the "Use legacy editor" setting until full support of the new editor is released.`, 30000);
                return;
            }
